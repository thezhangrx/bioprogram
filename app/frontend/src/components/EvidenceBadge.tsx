...
const RULES: { rx: RegExp; label: string; cls: string }[] = [
  { rx: /strong/i, label: "强一致性证据", cls: "bg-emerald-50 text-emerald-700 ring-emerald-200" },
  { rx: /moderate/i, label: "中等一致性证据", cls: "bg-amber-50 text-amber-700 ring-amber-200" },
  { rx: /model-specific|exploratory/i, label: "模型特异 / 探索性", cls: "bg-blue-50 text-blue-700 ring-blue-200" },
  { rx: /inconclusive/i, label: "不确定（Inconclusive）", cls: "bg-slate-100 text-slate-500 ring-slate-200" },
];
