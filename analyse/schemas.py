...
class EvidenceStrength(str, Enum):
    STRONG_STATISTICAL = "Strong statistical evidence"
    MODERATE_STATISTICAL = "Moderate statistical evidence"
    WEAK_STATISTICAL = "Weak statistical evidence"
    STRONG_ATTRIBUTION = "Strong attribution"
    MODERATE_ATTRIBUTION = "Moderate attribution"
    WEAK_ATTRIBUTION = "Weak attribution"
    STRONG_MUTATION_EFFECT = "Strong mutation effect"
    PREDICTIVE_DEPENDENCE = "Predictive dependence"
    CONVERGENT = "Convergent evidence"
    DIRECTIONALLY_CONSISTENT = "Directionally consistent"
    CONTEXT_CONSISTENT = "Context-consistent"
    SUPPORTING = "Supporting evidence"
    STABLE = "Stable"
    UNCERTAIN = "Uncertain"
    INCONCLUSIVE = "Inconclusive"
    NO_CURRENT_EVIDENCE = "No current evidence"   # 不等于 "no effect"
