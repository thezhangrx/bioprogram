"""analyse.reports.markdown_report — summary/*.md 生成 (Phase 2 切片: overview + QC 摘要)。"""
...
def build_hypotheses_md(matrix: pd.DataFrame) -> str:
    from analyse.evidence.hypothesis import generate_hypotheses_for_record
    from analyse.evidence.integration import tier_from_value
