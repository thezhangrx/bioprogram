"""analyse.tests.test_phase6 — pipeline 端到端报告/图形产物 (Phase 6)。

通过小型合成批次跑 run_analysis (只读语义), 验证:
  - summary 00-08 md 齐全 (本切片含 01/08 批次级报告);
...
from analyse.pipeline import run_analysis
from analyse.plans import AnalysisPlan
