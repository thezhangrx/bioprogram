...
from analyse.environment.factorial_dag import (EDGE_COLUMNS, ENV_FACTORS,
...
class TestEdgeTable(unittest.TestCase):
    ...
    def test_ci_merged_when_real_table_exists(self):
        from analyse.environment.factorial_dag import merge_edge_ci
    ...
    def test_matches_engine_incremental_effect(self):
        """与 analyse.environment.incremental_effect 的配对增量保持一致。"""
...
class TestRendererConsumesTablesOnly(unittest.TestCase):
    def test_render_from_dataframes(self):
        from analyse.visualization.factorial_dag import (render_conditional_delta_r2,
    ...
    def test_unavailable_node_is_drawn_not_dropped(self):
        ...
        from analyse.visualization.factorial_dag import render_factorial_dag
        table = _full_lattice_table()
