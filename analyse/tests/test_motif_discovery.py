...
from analyse.sequence.motif import core
from analyse.sequence.motif.iupac import (consensus_from_frequencies, contains_iupac,
...
class TestEndToEndMotifDiscovery(unittest.TestCase):
    ...
    def test_run_and_write_tables_and_report(self):
        ...
        with tempfile.TemporaryDirectory() as out:
            out = Path(out)
            res = run_and_write(self.attr, BATCH, out / "tables", out / "summary",
            ...
            self.assertTrue((out / "summary" / "04_sequence_and_motifs.md").exists())
            md = (out / "summary" / "04_sequence_and_motifs.md").read_text()
    ...
    def test_disabled_discovery_is_reported_not_faked(self):
        from analyse.sequence.motif.pipeline import run_motif_discovery
