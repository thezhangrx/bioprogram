...
to a review PDF with matplotlib, which can embed the system CJK font.
  ...
  python analysis/reporting/paper/make_pdf_fallback.py   ->  docs/paper/review/fallback_main.pdf
...
#: 论文根目录 = docs/paper（本脚本位于 analysis/reporting/paper/）
PAPER = _PROJECT_ROOT / "docs" / "paper"
ROOT = PAPER
...
def main() -> None:
    ...
    out = ROOT / "review" / "fallback_main.pdf"
