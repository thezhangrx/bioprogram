...
from analysis.stats.hypothesis_tests import (anova_interface, factorial_anova,
...
class TestTaskRunners(unittest.TestCase):
    ...
    def test_bootstrap_edges_from_predictions(self):
        from analysis.stats.tasks import bootstrap_environment_edges
    ...
    def test_permutation_edges_have_null_hypothesis(self):
        from analysis.stats.tasks import permutation_environment_edges
    ...
    def test_fdr_by_family(self):
        from analysis.stats.tasks import apply_fdr
        df = pd.DataFrame({
...
class TestMetricConsistency(unittest.TestCase):
    def test_flags_same_direction(self):
        from analysis.data.validation import metric_consistency_flags
...
class TestCelllineLabelsReachable(unittest.TestCase):
    def test_all_four_labels(self):
        from analysis.cellline.consistency import classify_cellline_consistency_detail
...
class TestRealBatchArtifacts(unittest.TestCase):
    def test_statistics_tables_present_and_consistent(self):
        ...
        status = json.loads((BATCH / "summary" / "analysis_status.json").read_text())
