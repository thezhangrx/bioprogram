...
\midrule
C1: position-18 base substitution & single-nucleotide & 3/5 models place position 18 in top-3 in $\ge$65\% of runs; PAM-proximal seed region is the highest region for 2/5 & mean efficacy C-A: HCT116 +0.090, HeLa +0.092, HL60 +0.027, HEK293T -0.015 & cell-line CNNs: $|\Delta R|$ for C$\rightarrow$A is larger in HCT116 (0.016--0.084) and HeLa (0.028--0.090) than HEK293T (0.003--0.007) and HL60 (0.002--0.017) & substitute position 18 (C$\leftrightarrow$A) keeping the rest of the sgRNA fixed & high \\
