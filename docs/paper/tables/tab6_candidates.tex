...
C2: GAGG candidate pattern (enriched) & motif disruption & shared by CNN k=3/5/7 contexts (50 contexts) & carrier-vs-background effect +0.012; OR=1.11 & BH-FDR=0.031 (motif\_enrichment family); single cell line (HeLa) & disrupt the 4-nt core inside the PAM-proximal window & medium \\
