...
结果根目录：`results/batches/batch_20260909_full/`（`summary/` 为分析产物，实验目录为训练产物）。
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 过滤后 16 749 条 23 nt 序列（HCT116 4 239 / HEK293T 2 333 / HeLa 8 101 / HL60 2 076） | `data/processed/{cell}_metadata.csv` | `sgRNA`, `Normalized efficacy` | Table 1 | 计数 | L1 |
...
| 第 18 位碱基组成按细胞系不同（HCT116 A0.390/C0.325/G0.285；HEK293T C0.265/A0.250/T0.247/G0.237；HeLa A0.405/C0.307/G0.289；HL60 C0.290/T0.244/A0.238/G0.227） | `data/processed/*_metadata.csv` | `sgRNA[17]` | Fig. 4C | 频率 | L1 |
