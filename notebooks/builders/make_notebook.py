    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "# 载入与解析数据\n",
                "# ==============================================================================\n",
                "from core.data.splitting.cell_line_division import load_feature_schema, load_cell_line\n",
                "\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "from core.models.linear.linear_regression import LinearRegressionModel, calculate_metrics\n",
                "\n",
                "# 划分 80% 训练，20% 快速测试\n",
                "n_samples = len(y)\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "调用 `predict.py` 内置的 Ultimate 候选设计引擎 (mixed 已测细胞系 + 10 折交叉验证超参选择) 与 `analysis/importance_extraction.py` 的关键调控特征库生成器，自动结合元数据染色体坐标 `chrX(start~end)` 与终极模型共识打分，直出符合大赛规范的最终交付文件。"
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                "import predict\n",
                "from analysis.importance_extraction import collect_all_model_features, generate_key_regulatory_biomarkers\n",
                "\n",
