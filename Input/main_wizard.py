...
class CRISPRPlatformWizard(tk.Tk):
    def __init__(self):
        ...
        self.form_data = {
            ...
            "xai_vars": {
                ...
                "mlp_sg": tk.BooleanVar(value=True),
    ...
    def _show_step(self, step: int):
        ...
        # Step 5
            ...
            cb_mlp_sg = ttk.Checkbutton(r3, text="计算 SmoothGrad 局部平滑扰动抗噪度", variable=self.form_data["xai_vars"]["mlp_sg"])
            cb_mlp_sg.pack(side=tk.LEFT, padx=15)
            self.xai_widgets["mlp"] = [cb_mlp_sg]
